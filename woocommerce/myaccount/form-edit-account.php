...
<form class="woocommerce-EditAccountForm edit-account nb-wc-form-register" action="" method="post">
	...
	<fieldset>
		<legend class="nb-text-title"><?php esc_html_e( 'Password change', 'woocommerce' ); ?></legend>
